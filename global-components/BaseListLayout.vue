  ...
  <div id="">
    ...
    >
      <article
        ...
        :key="page.key"
        itemprop="blogPost"
        class="ui-post entry col-md-4 card-container text-white"
        itemscope
      ...
      >
        ...
        <div class="entry card h-100">
          ...
          <div class="card-inside">
            <div class="card-subheading">
              <div
                ...
                class="ui-post-meta ui-post-tag text-white"
                itemprop="keywords"
              >
                <router-link
          ...
          <div class="meta-bottom mt-auto">
                ...
                <div class="d-flex">
                  ...
                  <div class="meta">
                    <div v-if="author.name === page.frontmatter.author">
                      <span class="username text-white">{{ author.name }}</span>
                      &nbsp;
                    </div>
                    <div></div>
                  </div>
            ...
            <div v-if="page.frontmatter.date" class="date text-white">
              <time
                pubdate
...
div.entry
  background-color rgba(21, 21, 21, 0.82) !important
  cursor pointer

  &:hover
    background-color #11111173 !important
